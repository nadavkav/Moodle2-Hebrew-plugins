...
$navlinks[] = array('name' => $room_obj->name, 'link' => '/blocks/roomscheduler/room_calendar.php?course='.$course.'&room='.$room_obj->id.'&time='.$time, 'type' => 'misc');
...
$cal = new calendar_month($room, $time);
echo $cal;
$cal->render_apptForm();
