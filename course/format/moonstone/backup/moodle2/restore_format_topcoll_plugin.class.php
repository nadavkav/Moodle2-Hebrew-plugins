...
class restore_format_moonstone_plugin extends restore_format_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        $elepath = $this->get_pathfor('/'); // This is defines the nested tag within 'plugin_format_moonstone_course' to allow '/course/plugin_format_moonstone_course' in the path therefore as a path structure representing the levels in course.xml in the backup file.
    ...
    /**
     * Process the 'plugin_format_moonstone_course' element within the 'course' element in the 'course.xml' file in the '/course' folder
    ...
    public function process_moonstone($data) {
        ...
        put_moonstone_setting($data->courseid, $data->layoutelement, $data->layoutstructure, $data->layoutcolumns, $data->tgfgcolour, $data->tgbgcolour, $data->tgbghvrcolour);
