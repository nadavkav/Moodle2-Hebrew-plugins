 ...
 **/
function moonstone_backup_format_data($bf, $preferences) {
    $status = true;

    if ($layout = get_record('format_moonstone_layout', 'courseid',
 ...
 **/
function moonstone_encode_format_content_links($content, $restore) {
    global $CFG;
