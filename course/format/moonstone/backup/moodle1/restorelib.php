...
function moonstone_restore_format_data($restore, $data) {
    global $CFG;
    ...
    if (!empty($data['FORMATDATA']['#']['LAYOUT']['0'])) {
        ...
        put_layout($restore->course_id, $layoutelement, $layoutstructure); // In $CFG->dirroot.'/course/format/moonstone/lib.php'.
    }
    return $status;
}
 ...
 * @return boolean
 **/
function moonstone_decode_format_content_links_caller($restore) {
    return true;
}
 ...
 **/
function moonstone_decode_format_content_links($content, $restore) {
