...
// Course format original suggestion
$format['defaultblocks'] = ':search_forums,news_items,calendar_upcoming,recent_activity';
// Main config.php suggestion
//$format['defaultblocks'] = 'participants,activity_modules,search_forums,course_list:news_items,calendar_upcoming,recent_activity';
// moonstone suggestions...
//$format['defaultblocks'] = 'settings,navigation:news_items,calendar_upcoming,recent_activity';
//
