...
$string['namemoonstone']='Ingeklapte Onderwerpen format';
$string['formatmoonstone']='Ingeklapte Onderwerpen format';

// Used in format.php
$string['moonstonetoggle']='Uitklappen';
$string['moonstonetogglewidth']='width: 42px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='alle schakelt.';
$string['moonstoneopened']='Open';
$string['moonstoneclosed']='Sluit';
