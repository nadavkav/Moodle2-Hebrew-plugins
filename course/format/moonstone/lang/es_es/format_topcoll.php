...
$string['namemoonstone']='Temas plegados';
$string['formatmoonstone']='Temas plegados';

// Used in format.php
// Utilizado en format.php
$string['moonstonetoggle']='Activar';
$string['moonstonetogglewidth']='width: 32px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='Cambiar';
$string['moonstoneopened']='Todos abiertos'; /*all open*/
$string['moonstoneclosed']='Todos cerrados'; /*all closed*/
...
// MDL-26105
$string['page-course-view-moonstone'] = 'Cualquier página principal del curso en el formato temas desplegables';
$string['page-course-view-moonstone-x'] = 'Cualquier página del curso en el formato temas desplegables';
