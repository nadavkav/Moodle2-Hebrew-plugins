...
$string['namemoonstone']='Pynciau Dymchwel';
$string['formatmoonstone']='Pynciau Dymchwel';

// Used in format.php
// A ddefnyddir mewn format.php
$string['moonstonetoggle']='Toggle';
$string['moonstonetogglewidth']='width: 36px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='pob toglau.';
$string['moonstoneopened']='Agored';
$string['moonstoneclosed']='Cau';
