...
$string['namemoonstone']='Compresso Argomenti';
$string['formatmoonstone']='Compresso Argomenti';

// Used in format.php
// Utilizzato in format.php
$string['moonstonetoggle']='Olivetta';
$string['moonstonetogglewidth']='width: 42px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='';
$string['moonstoneopened']="Aperto tutto l'alterna.";
$string['moonstoneclosed']='Chiudere tutte le alterna.';
