...
$string['namemoonstone']='Komprimiert Themen';
$string['formatmoonstone']='Komprimiert Themen';

// Used in format.php
// Verwendet in format.php
$string['moonstonetoggle']='Sehen';
$string['moonstonetogglewidth']='width: 30px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='alle wechselt.';
$string['moonstoneopened']='Geöffnet';
$string['moonstoneclosed']='Schließen sie';
