...
$string['namemoonstone']='Zwiniety Tematy';
$string['formatmoonstone']='Zwiniety Tematy';

// Used in format.php
// Uzywane w format.php
$string['moonstonetoggle']='Dzwignia kolankowa';
$string['moonstonetogglewidth']='width: 34px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='wszystkie przełączniki.';
$string['moonstoneopened']='Otwórz';
$string['moonstoneclosed']='Zamknij';
