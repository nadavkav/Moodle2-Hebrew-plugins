...
$string['namemoonstone']='Сворачиваемые разделы по темам';
$string['formatmoonstone']='Сворачиваемые разделы по темам';

// Used in format.php
$string['moonstonetoggle']='Показать/Скрыть';
$string['moonstonetogglewidth']='width: 32px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='все разделы.';
$string['moonstoneopened']='Показать';
$string['moonstoneclosed']='Скрыть';
