...
$string['namemoonstone']='Sections réduites';
$string['formatmoonstone']='Sections réduites';

// Used in format.php
// Employée au format.php
$string['moonstonetoggle']='Basculer';
$string['moonstonetogglewidth']='width: 32px;';

// Toggle all - Moodle Tracker CONTRIB-3190
$string['moonstoneall']='toutes les sections.';
$string['moonstoneopened']='Ouvrir';
$string['moonstoneclosed']='Fermer';
...
// MDL-26105
$string['page-course-view-moonstone'] = 'Toutes les pages du cours principal au format sections réduites';
$string['page-course-view-moonstone-x'] = 'Toutes les pages du cours au format sections réduites';
...
$string['resetlayout_help'] = 'Réinitialise les réglages par les valeurs par défaut présentes dans le fichier "/course/format/moonstone/config.php", ce sera donc le format de base de cours au format sections réduites';
...
$string['resetcolour_help'] = 'Réinitialise les couleurs par les valeurs par défaut présentes dans le fichier "/course/format/moonstone/config.php", ce sera donc le format de base de cours au format sections réduites';
// Moodle Tracker CONTRIB-3624
$string['setcookieconsent_help'] = "Si vous choisissez 'Autorisé', vous acceptez qu'à la prochaine fois que vous cliquez sur les basculements de sections, dans n'importe quel cours ayant le format 'Sections Réduites', le cookie 'mdl_cf_moonstone' s'enregister dans votre ordinateur le temps de votre session.
