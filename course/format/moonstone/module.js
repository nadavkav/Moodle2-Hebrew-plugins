 ...
 */
M.format_moonstone.init = function(Y, wwwroot, thecourseid, thetogglestate) {
    // Init.
    ourYUI = Y;
    thewwwroot = wwwroot;
...
M.format_moonstone.set_current_section = function (Y, theSection) {
    ...
    if(document.getElementById)
    {
        ...
        if (target.style.display == displaySetting)
        {
            ...
            if (mymobiletheme == true) {
                ...
                image.style.backgroundImage = "url(" + thewwwroot + "/course/format/moonstone/images/arrow_down.png)";
            }
        ...
        else
        {
            ...
            if (mymobiletheme == true) {
                ...
                image.style.backgroundImage = "url(" + thewwwroot + "/course/format/moonstone/images/arrow_up.png)";
            }
...
{
    M.util.set_user_preference('moonstone_toggle_'+courseid , value);
}
...
M.format_moonstone.reload_toggles = function (Y, aToggle) {
