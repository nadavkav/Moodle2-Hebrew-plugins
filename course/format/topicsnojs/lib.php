 ...
 */
function callback_topicsnojs_uses_sections() {
    return true;
}
 ...
 * @return bool Returns true
 */
function callback_topicsnojs_load_content(&$navigation, $course, $coursenode) {
    return $navigation->load_generic_course_sections($course, $coursenode, 'topicsnojs');
}
 ...
 * @return string
 */
function callback_topicsnojs_definition() {
 ...
 * @return stdClass
 */
function callback_topicsnojs_ajax_support() {
 ...
 */
function callback_topicsnojs_ajax_section_move($course) {
    global $COURSE, $PAGE;

    $titles = array();
    rebuild_course_cache($course->id);
    $modinfo = get_fast_modinfo($COURSE);
    $renderer = $PAGE->get_renderer('format_topicsnojs');
