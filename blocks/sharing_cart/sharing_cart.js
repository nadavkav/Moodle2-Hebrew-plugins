 ...
 *
 * @author VERSION2 Inc.
 * @version $Id: sharing_cart.js,v 1.5 2010/01/26 03:44:20 akiococom Exp $
 * @package sharingcart
 */
...
// private:
	...
	var createIcon = function (src, alt, cls)
	{
		...
		icon.src       =  parameters.wwwroot+"/theme/image.php?theme=standard&image=" + src;
		icon.alt       = alt;
		icon.className = cls;
		return icon;
	};
	...
	this.init = function ()
	{
		var insert = function (sec, sec_i)
		{
			...
			for (var i = 0; i < cmds.length; i++) {
				var mod_id = cmds[i].parentNode.parentNode.id.split("-")[1];
