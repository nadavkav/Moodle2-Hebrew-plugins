...
if ($subcourse->instantredirect) {
    ...
    redirect($CFG->wwwroot.'/course/view.php?id='.$subcourse->refcourse);
}
...
$output = $PAGE->get_renderer('mod_subcourse');
$subcourse = new subcourse($subcourse);
$subcourse->cm = $cm;
echo $output->render($subcourse);
